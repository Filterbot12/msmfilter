...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            ...
            InlineKeyboardButton('🤠 Dev 🤠', url='https://t.me/Professor_host'), 
            InlineKeyboardButton('📢 UPDATES 📢', url='https://t.me/msmOTT')
            ],[      
